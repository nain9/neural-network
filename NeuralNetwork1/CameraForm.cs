...
namespace AForge.WindowsForms
{
    ...
    public partial class CameraForm : Form
    {
        ...
        private NeuralNetworksStand mainForm;
        ...
        private void UpdateFormFields()
        {
            ...
            mainForm.SetImageFromCamera(controller.GetProcessedImage());
        ...
        public CameraForm(NeuralNetworksStand mainForm)
        {
            InitializeComponent();
            ...
            controller.settings.processImg = false;
